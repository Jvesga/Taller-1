...
if(numero > 0):
    print("El numero dijitado es positivo y esta en la posicion " , numero , "de la recta numerica. ")

elif(numero < 0):
    print("El numero digitado es negativo y esta en la posicion " , numero , "de la recta numerica. ")
