...
# Un laboratorio necesita convertir mediciones térmicas desde la escala 
#Celsius hacia las escalas Fahrenheit (usada en países anglosajones) y 
#Kelvin (escala absoluta científica). 
